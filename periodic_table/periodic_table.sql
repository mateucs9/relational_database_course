...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_symbol UNIQUE (symbol, name);


--
-- Name: properties at_num_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT at_num_fkey FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties type_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_fkey FOREIGN KEY (type_id) REFERENCES public.types(type_id);
